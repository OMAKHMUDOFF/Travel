...
export const TourDetails = () => {
  ...
  const { tourpackages, baseUrl, hotelandrooms } = useSelector(
  ...
  const { images, location, title, more, description, previewImage } = tourData;
    ...
    <>
      ...
      <section>
        <div className="flex flex-col gap-5 container">
          <div>
            <p className="text-[#4d4d4d]">Our Best Tours & Hotels</p>
            <h1 className="text-2xl">
              Best tour to <span className="capitalize">{location}</span>
            </h1>
